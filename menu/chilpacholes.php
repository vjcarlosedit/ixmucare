    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('platillo1')">
                <img src="assets/images/menu/chilpacholes/Chilpacholedecamarón.jpg" alt="Fuente de mariscos" class="platillo-img">
                <h3>Chilpachole de camarón</h3>
                <p class="price">$180</p>
            ...
            <div class="platillo-card" onclick="openModal('platillo2')">
                <img src="assets/images/menu/chilpacholes/Chilpacholedeaiba.jpg" alt="Festín de camarones" class="platillo-img">
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/chilpacholes/Chilpacholemixtacamarónyjaiba.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Chilpachole mixta camarón y jaiba</h3>
                <p class="price">$195</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
