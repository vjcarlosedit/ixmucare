    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('platillo1')">
                <img src="assets/images/menu/pulpo/pulpo-al-chiltepin.jpg" alt="Fuente de mariscos" class="platillo-img">
                <h3>Pulpo al chiltepín</h3>
                <p class="price">$235</p>
            ...
            <div class="platillo-card" onclick="openModal('platillo2')">
                <img src="assets/images/menu/pulpo/Pulpoalamantequilla.jpg" alt="Festín de camarones" class="platillo-img">
                <h3>Pulpo a la mantequilla</h3>
                <p class="price">$235</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/pulpo/Pulpo-a-las-brasas.jpg" alt="Dedos de pescado tempura" class="platillo-img">
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/pulpo/Pulpoalgratin.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Pulpo al gratin</h3>
                <p class="price">$235</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
