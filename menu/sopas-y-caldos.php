    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('platillo1')">
                <img src="assets/images/menu/sopas-caldos/Sopademariscos.jpg" alt="Fuente de mariscos" class="platillo-img">
            ...
            <div class="platillo-card" onclick="openModal('platillo2')">
                <img src="assets/images/menu/sopas-caldos/Arrozconcamarón.jpg" alt="Festín de camarones" class="platillo-img">
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/sopas-caldos/Arrozconcamarón.jpg" alt="Dedos de pescado tempura" class="platillo-img">
