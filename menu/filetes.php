    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('platillo1')">
                <img src="assets/images/menu/filetes/Fileteempanizado.jpg" alt="Fuente de mariscos" class="platillo-img">
            ...
            <div class="platillo-card" onclick="openModal('platillo2')">
                <img src="assets/images/menu/filetes/Fileterellenodemariscosqueso.jpg" alt="Festín de camarones" class="platillo-img">
                <h3>Filete relleno de mariscos c/queso</h3>
                <p class="price">$205</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/filetes/Filetealgratin.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Filete al gratin</h3>
                <p class="price">$190</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/filetes/Filetealaplancha.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Filete a la plancha</h3>
                <p class="price">$185</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/filetes/Filetealaveracruzana.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Filete a la veracruzana</h3>
                <p class="price">$225</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
