    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('platillo1')">
                <img src="assets/images/menu/infantil/Pulpoguetti.jpg" alt="Fuente de mariscos" class="platillo-img">
                <h3>Pulpoguetti</h3>
                <p class="price">$160</p>
            ...
            <div class="platillo-card" onclick="openModal('platillo2')">
                <img src="assets/images/menu/infantil/Fishfingers.webp" alt="Festín de camarones" class="platillo-img">
                <h3>Fish fingers</h3>
                <p class="price">$160</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/infantil/Pastadealbondigas.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Pasta de albondigas</h3>
                <p class="price">$160</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/infantil/Philadelphiababyshrimp.webp" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Philadelphiababy shrimp</h3>
                <p class="price">$160</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/infantil/Cangrebursitas.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Cangrebursitas</h3>
                <p class="price">$165</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
