...
<body>
    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('ceviche1')">
                <img src="assets/images/menu/ceviches/Ceviche-de-Pescado.jpg" alt="Fuente de mariscos" class="platillo-img">
            ...
            <div class="platillo-card" onclick="openModal('ceviche2')">
                <img src="assets/images/menu/ceviches/Cevichede_camarón_pescado.avif" alt="Festín de camarones" class="platillo-img">
                <h3>Ceviche de camarón c/pescado</h3>
                <p class="price">$200</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            </div>
            <div class="platillo-card" onclick="openModal('ceviche3')">
                <img src="assets/images/menu/ceviches/Ceviche_de_camarón.jpg" alt="Dedos de pescado tempura" class="platillo-img">
            ...
            <div class="platillo-card" onclick="openModal('ceviche4')">
                <img src="assets/images/menu/ceviches/Ceviche_mixto.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Ceviche mixto</h3>
                <p class="price">$210</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
