...
<body>
    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('jarra1')">
                <img src="assets/images/menu/jarras/horchata.webp" alt="Fuente de mariscos" class="platillo-img">
                <h3>Horchata</h3>
                <p class="price">$110</p>
            ...
            <div class="platillo-card" onclick="openModal('jarra2')">
                <img src="assets/images/menu/jarras/jamaica.webp" alt="Festín de camarones" class="platillo-img">
                <h3>Jamaica</h3>
                <p class="price">$110</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
            ...
            <div class="platillo-card" onclick="openModal('jarra3')">
                <img src="assets/images/menu/jarras/limon.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Limonada</h3>
                <p class="price">$100</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
