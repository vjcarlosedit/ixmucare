...
<body>
    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('novedades1')">
                <img src="assets/images/menu/novedades/Langosta-mantequilla.jpg" alt="Fuente de mariscos" class="platillo-img">
                <h3>Langosta a la mantequilla</h3>
                <p class="price">$550</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            </div>
            <div class="platillo-card" onclick="openModal('novedades2')">
                <img src="assets/images/menu/novedades/Chilpachole-jaiba.jpg" alt="Festín de camarones" class="platillo-img">
                <h3>Chilpachole de jaiba</h3>
                <p class="price">$240</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            </div>
            <div class="platillo-card" onclick="openModal('novedades3')">
                <img src="assets/images/menu/novedades/Camarones Teriyaki.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Camarones Teriyaki</h3>
                <p class="price">$330</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
