    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('platillo1')">
                <img src="assets/images/menu/ostiones/Ostiones_al_apesco.jpg" alt="Fuente de mariscos" class="platillo-img">
                <h3>Ostiones al tapesco</h3>
                <p class="price">$70</p>
            ...
            <div class="platillo-card" onclick="openModal('platillo2')">
                <img src="assets/images/menu/ostiones/Ostiones_al_chiltepín.jpg" alt="Festín de camarones" class="platillo-img">
                <h3>Ostiones al chiltepín</h3>
                <p class="price">$170</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/ostiones/Ostiones_a_la_mantequilla.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Ostiones a la mantequilla</h3>
                <p class="price">$170</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/ostiones/Ostiones_Rockefeller.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Ostiones Rockefeller</h3>
                <p class="price">$190</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
