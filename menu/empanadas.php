    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('platillo1')">
                <img src="assets/images/menu/empanadas/Empanadas_de_camarón.jpg" alt="Fuente de mariscos" class="platillo-img">
            ...
            <div class="platillo-card" onclick="openModal('platillo2')">
                <img src="assets/images/menu/empanadas/Empanadas_de_jaiba.jpg" alt="Festín de camarones" class="platillo-img">
                <h3>Empanadas de jaiba</h3>
                <p class="price">$120</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/empanadas/Empanadas_de_cazón.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Empanadas de cazón</h3>
                <p class="price">$120</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/empanadas/Empanadas_de_queso.jpg" alt="Dedos de pescado tempura" class="platillo-img">
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/empanadas/Empanadas_de_camarón_queso.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Empanadas de camarón c/queso</h3>
                <p class="price">$135</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
