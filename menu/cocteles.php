    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('platillo1')">
                <img src="assets/images/menu/cocteles/Cocteldecamarón.jpg" alt="Fuente de mariscos" class="platillo-img">
            ...
            <div class="platillo-card" onclick="openModal('platillo2')">
                <img src="assets/images/menu/cocteles/Cocteldecamarónjaiba.jpg" alt="Festín de camarones" class="platillo-img">
                <h3>Coctel de camarón c/jaiba</h3>
                <p class="price">$190</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/cocteles/Cocteldecamaróncostión.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Coctel de camarón c/ostión</h3>
                <p class="price">$185</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/cocteles/Cocteldeostión.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Coctel de ostión</h3>
                <p class="price">$185</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
