    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('platillo1')">
                <img src="assets/images/menu/tortillas/Tortilla_asadero_de_amarón.jpg" alt="Fuente de mariscos" class="platillo-img">
                <h3>Tortilla asadero de camarón</h3>
                <p class="price">$175</p>
            ...
            <div class="platillo-card" onclick="openModal('platillo2')">
                <img src="assets/images/menu/tortillas/Tortilla_asadero_de_marisco.jpg" alt="Festín de camarones" class="platillo-img">
                <h3>Tortilla asadero de marisco</h3>
                <p class="price">$180</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/tortillas/Tortilla_asadero_de_camarón_bañado_al_chiltepín.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Tortilla asadero de camarón bañado al chiltepín</h3>
                <p class="price">$190</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
