    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('platillo1')">
                <img src="assets/images/menu/ensaladas-pastas/Ensaladadecamarón.jpg" alt="Fuente de mariscos" class="platillo-img">
                <h3>Ensalada de camarón</h3>
                <p class="price">$190</p>
            ...
            <div class="platillo-card" onclick="openModal('platillo2')">
                <img src="assets/images/menu/ensaladas-pastas/Ensaladadejaiba.jpg" alt="Festín de camarones" class="platillo-img">
                <h3>Ensalada de jaiba</h3>
                <p class="price">$190</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/ensaladas-pastas/Ensaladadecamarónjaiba.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Ensalada de camarón c/jaiba</h3>
                <p class="price">$190</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            ...
            <div class="platillo-card" onclick="openModal('platillo3')">
                <img src="assets/images/menu/ensaladas-pastas/Ensaladamarytierra.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Ensalada mar y tierra</h3>
                <p class="price">$190</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
