...
<body>
    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('brocheta1')">
                <img src="assets/images/menu/brochetas/brochetas_de_camaron_asadas.jpg" alt="Fuente de mariscos" class="platillo-img">
                <h3>Brochetas de camarón asadas</h3>
                <p class="price">$195</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            </div>
            <div class="platillo-card" onclick="openModal('brocheta2')">
                <img src="assets/images/menu/brochetas/Brochetasdemarytierra.jpg" alt="Festín de camarones" class="platillo-img">
                <h3>Brochetas de mar y tierra</h3>
                <p class="price">$195</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            </div>
            <div class="platillo-card" onclick="openModal('brocheta3')">
                <img src="assets/images/menu/brochetas/Brochetasderesalasbrasas.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Brochetas de res a las brasas</h3>
                <p class="price">$200</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
