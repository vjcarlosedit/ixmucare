...
<body>
    ...
    <section id="platillos">
        ...
        <div class="platillos-grid">
            <div class="platillo-card" onclick="openModal('adicional1')">
                <img src="assets/images/menu/adicionales/Aguacate.jpg" alt="Fuente de mariscos" class="platillo-img">
                <h3>Aguacate</h3>
                <p class="price">$50</p>
            ...
            <div class="platillo-card" onclick="openModal('adicional2')">
                <img src="assets/images/menu/adicionales/Guacamole.jpg" alt="Festín de camarones" class="platillo-img">
                <h3>Guacamole</h3>
                <p class="price">$70</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
            ...
            <div class="platillo-card" onclick="openModal('adicional3')">
                <img src="assets/images/menu/adicionales/Ensaladavariada.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Ensalada variada</h3>
                <p class="price">$60</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            </div>
            <div class="platillo-card" onclick="openModal('adicional4')">
                <img src="assets/images/menu/adicionales/Verdurascocidas.jpeg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Verduras cocidas</h3>
                <p class="price">$60</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
                </button> -->
            </div>
            <div class="platillo-card" onclick="openModal('adicional5')">
                <img src="assets/images/menu/adicionales/Papasfritas.jpg" alt="Dedos de pescado tempura" class="platillo-img">
                <h3>Papas fritas</h3>
                <p class="price">$60</p>
                <!-- <button class="add-to-cart-btn" onclick="window.location.href='http://localhost/ixmucare-admin/login.php'">
                    <i class="fas fa-plus"></i>
